<template>
    <v-form ref="form" v-model="formDataRules.valid" lazy-validation>
        ...
        <v-switch v-model="formData.active" flat :label="`Switch 1: ${formData.active.toString()}`" ></v-switch>
        ...
        <v-textarea :value="formData.short_description" :counter="300" :rules="formDataRules.short_description_rules" clearable clear-icon="mdi-close-circle" outlined label="Short description" ></v-textarea>
        ...
        <v-textarea :value="formData.meta_description" :counter="170" :rules="formDataRules.short_description_rules" clearable clear-icon="mdi-close-circle" outlined label="Meta description" ></v-textarea>
