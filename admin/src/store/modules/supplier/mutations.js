export const RESET_SUPPLIER_FORM = (state) => {
    ...
    state.form.contact_person.id            = null;
...
export const SET_SUPPLIER_FORM_DATA = (state, data) => {
    ...
    state.form.address.id                   = data.address[0].id;
    ...
    state.form.contact_person.id            = data.contact_person[0].id;
    ...
    state.form.contact_person.middle_name   = (data.contact_person[0].middle_name) ? data.contact_person[0].middle_name : "";
